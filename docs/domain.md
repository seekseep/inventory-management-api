...
SKU（Stock Keeping Unit）単位で管理する最小単位の商品。
同じデザインでもカラー・サイズが異なれば別の SKU として扱う。

```
例: スリムデニム
├── SLIM-DENIM-BLK-S  (ブラック / S)
├── SLIM-DENIM-BLK-M  (ブラック / M)
├── SLIM-DENIM-BLK-L  (ブラック / L)
├── SLIM-DENIM-IND-S  (インディゴ / S)
├── SLIM-DENIM-IND-M  (インディゴ / M)
└── SLIM-DENIM-IND-L  (インディゴ / L)
```
