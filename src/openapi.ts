  ...
  paths: {
    "/api/item-categories": {
      get: {
        tags: ["カテゴリ"],
        summary: "カテゴリ一覧",
        responses: { "200": { description: "OK", content: { "application/json": { schema: { type: "array", items: { $ref: "#/components/schemas/ItemCategory" } } } } } },
      },
      post: {
        tags: ["カテゴリ"],
        summary: "カテゴリ作成",
    ...
    "/api/item-categories/{id}": {
      get: {
        ...
        responses: { "200": { description: "OK", content: { "application/json": { schema: { $ref: "#/components/schemas/ItemCategory" } } } }, "404": { description: "Not found" } },
      },
      put: {
        tags: ["カテゴリ"],
        summary: "カテゴリ更新",
        parameters: [{ name: "id", in: "path", required: true, schema: { type: "string" } }],
        requestBody: { required: true, content: { "application/json": { schema: { type: "object", properties: { name: { type: "string" }, parentId: { type: "string" }, description: { type: "string" } } } } } },
    ...
    "/api/items/{id}": {
      get: {
        ...
        summary: "商品取得",
        parameters: [{ name: "id", in: "path", required: true, schema: { type: "string" } }],
        responses: { "200": { description: "OK", content: { "application/json": { schema: { $ref: "#/components/schemas/Item" } } } }, "404": { description: "Not found" } },
      },
      put: {
        tags: ["商品"],
        summary: "商品更新",
    ...
    "/api/locations": {
      get: {
        tags: ["拠点"],
        summary: "拠点一覧",
        responses: { "200": { description: "OK", content: { "application/json": { schema: { type: "array", items: { $ref: "#/components/schemas/Location" } } } } } },
      },
      post: {
        tags: ["拠点"],
        summary: "拠点作成",
        requestBody: { required: true, content: { "application/json": { schema: { type: "object", required: ["name", "type"], properties: { name: { type: "string" }, type: { type: "string", enum: ["store", "warehouse"] }, address: { type: "string" } } } } } },
    ...
    "/api/locations/{id}": {
      ...
      put: {
        ...
        summary: "拠点更新",
        parameters: [{ name: "id", in: "path", required: true, schema: { type: "string" } }],
        requestBody: { required: true, content: { "application/json": { schema: { type: "object", properties: { name: { type: "string" }, type: { type: "string" }, address: { type: "string" } } } } } },
        responses: { "200": { description: "OK" } },
      },
      delete: {
        tags: ["拠点"],
    ...
    "/api/inventories/{id}": {
      get: {
        ...
        summary: "在庫取得",
        parameters: [{ name: "id", in: "path", required: true, schema: { type: "string" } }],
        responses: { "200": { description: "OK", content: { "application/json": { schema: { $ref: "#/components/schemas/Inventory" } } } }, "404": { description: "Not found" } },
      },
      put: {
        tags: ["在庫"],
        summary: "在庫更新",
        parameters: [{ name: "id", in: "path", required: true, schema: { type: "string" } }],
        requestBody: { required: true, content: { "application/json": { schema: { type: "object", properties: { quantity: { type: "integer" }, safetyStock: { type: "integer" } } } } } },
        responses: { "200": { description: "OK" } },
      },
    },
    "/api/transactions": {
